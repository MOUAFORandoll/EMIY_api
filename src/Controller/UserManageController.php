...
class UserManageController extends AbstractController
{
    ...
    /**
     * @Route("/client/read", name="userRead", methods={"POST"})
     * @param Request $request
     * @return JsonResponse
    ...
    /**
     * @Route("/client/state", name="clientState", methods={"POST"})
     * @param Request $request
     * @return JsonResponse
     * @throws ClientExceptionInterface
     * @throws DecodingExceptionInterface
    ...
    /**
     * @Route("/admin/new", name="adminNew", methods={"POST"})
     * @param Request $request
     * @return JsonResponse
     * @throws ClientExceptionInterface
     * @throws DecodingExceptionInterface
    ...
    /**
     * @Route("/client/make", name="clientMake", methods={"POST"})
     * @param Request $request
     * @return JsonResponse
     * @throws ClientExceptionInterface
     * @throws DecodingExceptionInterface
     ...
     * 
     */
    public function clientMake(Request $request)
    {
